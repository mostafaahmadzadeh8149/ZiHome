...
const SimpleSlider = ({ products, link }) => {
      ...
      >
        {products.slice(0, 18).map((product, index) => (
          <SwiperSlide
            ...
            className="!w-[150px] md:!w-[180px] flex justify-center"
          >
            <SimpleCartProduct {...product} index={index} />
          </SwiperSlide>
        ))}

        <SwiperSlide className="!w-[150px] md:!w-[180px] flex items-center justify-center">
          <div className="bg-white w-full h-[200px] md:h-[270px] flex flex-col items-center justify-center rounded-bl-xl rounded-tl-xl shadow-sm cursor-pointer">
            <Link
              to={link}
              className="flex items-center justify-center gap-1 text-black whitespace-nowrap"
            >
